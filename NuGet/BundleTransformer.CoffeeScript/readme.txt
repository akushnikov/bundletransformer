   ...
   ----------------------------------------------------------------------
        README file for Bundle Transformer: CoffeeScript 1.7.6 Beta 1
   ...
   version 1.6.1). This adapter makes translation of CoffeeScript-code 
   ...
   RELEASE NOTES
   =============
   Added support of CoffeeScript version 1.6.2.
