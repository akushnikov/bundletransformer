   ...
   ----------------------------------------------------------------------
      README file for JavaScript Engine Switcher for .Net: MSIE 1.1.0
   ...
   RELEASE NOTES
   =============
   1. Added support of MSIE JavaScript Engine version 1.3.0;
   2. Added the `/configuration/jsEngineSwitcher/msie` configuration
      section.
