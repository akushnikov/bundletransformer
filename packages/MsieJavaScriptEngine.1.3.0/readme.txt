   ...
   ----------------------------------------------------------------------
           README file for MSIE JavaScript Engine for .NET 1.3.0
   ...
   RELEASE NOTES
   =============
   1. Added support of the JsRT version of Chakra;
   2. Now the MSIE JavaScript Engine can work in 4 modes: `Auto` (selected
      by default), `Classic`, `ChakraActiveScript` and `ChakraJsRt`;
   3. Following methods are obsolete: `HasProperty`, `GetPropertyValue`,
